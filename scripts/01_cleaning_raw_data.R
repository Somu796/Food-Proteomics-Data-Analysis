...
# # saving_data: yes
# # data_name: "data/ST_data/01_gene_data_post_01_cleaning.RData", 
# #             "data/LT_data/01_gene_data_post_01_cleaning.RData",
# #             "data/ST_data/02_sample_details_sample_labels_post_01_cleaning.RData", 
# #             "data/LT_data/02_sample_details_sample_labels_post_01_cleaning.RData"
# 
# # 1. Library --------------------------------------------------------------
...
# data_type = c("ST", 
#               "LT")
# rawdata_path = c("data/raw data/Progenesis_ST_815_Quantifiable_prot_All.csv", 
#                  "data/raw data/Progenesis_LT_817_Quantifiable_prot_All.csv")
# save_gene_data_path = c("data/ST_data/01_gene_data_post_01_cleaning.RData", 
#                         "data/LT_data/01_gene_data_post_01_cleaning.RData")
# save_sample_details_path = c("data/ST_data/02_sample_details_sample_labels_post_01_cleaning.RData", 
#                              "data/LT_data/02_sample_details_sample_labels_post_01_cleaning.RData")
# 
# 
# # 4. Running the functions ------------------------------------------------
# 
# for (i in 1:length(rawdata_path)){
# data_cleaning(rawdata_path[i], save_gene_data_path[i], save_sample_details_path[i])
# }
# 
# 
...
# for (i in 1:length(rawdata_path)){
#   load(save_gene_data_path[i])
#   assign(paste0("gene_data_", data_type[i]), gene_data)
#   
#   load(save_sample_details_path[i])
#   assign(paste0("sample_details_", data_type[i]), sample_details)
# }
...
# # 
# # # ST data
# # gene_data <- read_csv("data/raw data/Progenesis_ST_815_Quantifiable_prot_All.csv")
# # 
# # gene_data <- gene_data %>%
# #   # remove_col: Cleaning from "Raw abundance" (modify)
# #   select(all_of(colnames(gene_data)[1:which(colnames(gene_data) == "Raw abundance")-1])) %>%
...
# # # 5. Saving the data in .RData format for future use ----------------------
# # gene_data
# # save(gene_data, file = "data/ST_data/01_gene_data_post_01_cleaning.RData")
# # sample_details
# # save(sample_details, file = "data/ST_data/02_sample_details_sample_labels_post_01_cleaning.RData")
# # 
# # 
